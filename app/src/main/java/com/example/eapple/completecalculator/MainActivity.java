package com.example.eapple.completecalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void calculateAnswer(){
        //String exp = "pi*10";
        String exp = calcField.getText().toString();
        try {
            Expression expression = new ExpressionBuilder(exp).variable("pi").build().setVariable("pi", 3.14);

            Function avg = new Function("sqrt", 1) {
                @Override
            ...
            calcField.setText(form.format(result));

        }catch (Exception exception){
            Toast.makeText(this,"Exception: " + exception.toString(), Toast.LENGTH_SHORT).show();
